                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm text-blue-700">
                                                This category is currently assigned to <strong>{{ $category->companies_count }}</strong> 
                                                {{ Str::plural('company', $category->companies_count) }}. 
                                                Making it inactive will hide it from new company forms but won't affect existing assignments.
                                            </p>
                                        </div>
                                    </div>
                                </div>

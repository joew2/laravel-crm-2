                            ...
                            <div class="mb-3 space-y-3">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <span class="text-sm text-gray-500">
                                        <span id="selectedCount">{{ $company->categories->count() }}</span> of {{ $categories->count() }} selected
                                    </span>
                                </div>
                            </div>
                                ...
                                @foreach($categories as $category)
                                    <label class="flex items-center py-2 hover:bg-gray-50 cursor-pointer rounded px-2 transition-colors duration-150">
                                        <input type="checkbox" 
                                               name="categories[]" 
                                               value="{{ $category->id }}"
                                               {{ in_array($category->id, old('categories', $company->categories->pluck('id')->toArray())) ? 'checked' : '' }}
